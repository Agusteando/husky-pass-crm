...
.compact-empty { align-items: center; background: linear-gradient(135deg, rgba(var(--pa-primary-rgb), .08), #fff); border: 1px solid var(--pa-border); border-radius: 12px; display: grid; gap: 4px; min-height: 132px; padding: 16px; text-align: center; }
