...
export default defineNuxtRouteMiddleware(async () => {
  ...
  if (session.user?.kind === 'admin' && hasGestionEscolarAdminScope(session.user)) return navigateTo(session.user.isSuperAdmin ? '/admin/superadmin' : '/admin/gestion-escolar')
