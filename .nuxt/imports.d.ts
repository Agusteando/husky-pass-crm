...
export { INSTITUTIONAL_ONBOARDING_ROUTE, INSTITUTIONAL_ROLE_OPTIONS, INSTITUTIONAL_PLANTEL_OPTIONS, plantelOptionsForRole, institutionalRoleOption } from '../utils/institutionalOnboarding';
...
export { MARBETE_HOLOGRAM_URL } from '../utils/marbeteHologramAsset';
export { MARBETE_SVG_LAYER_DEFINITIONS, parseSvgCanvas, extractBaseMarbeteLayers, stripBaseDynamicFields, createDefaultMarbeteSvgDesign, createMarbeteSvgDesignFromBase, normalizeMarbeteSvgDesign, resizeMarbeteSvgDesign, rebaseMarbeteSvgDesign, appendMarbeteSvgDesign, previewMarbeteBaseSvg, previewMarbeteSvg, marbeteSvgLayerDefinition, MarbeteSvgLayerDefinition } from '../utils/marbeteSvgEditor';
export { normalizeDynamicPhotoFrames, renderMarbeteSvgValues } from '../utils/marbeteSvgRuntime';
...
export { PA_COLORS, PERSONAS_THEMES, normalizePlantel, normalizeNivel, resolveAuthorizedPersonMarbetePlantel, resolveAuthorizedPersonMarbeteLevel, personasThemeKeyFromMatricula, resolvePersonasTheme, personasThemeStyle, allPersonasThemes, personasMascot, personasLevelName, personasInstitutionName, personasInstitutionLogo, PersonasMascotVariant, AuthorizedPersonMarbeteLevel } from '../utils/personasTheme';
export { anonymousSession, useRouteSessionCache, useAccountStateEpoch, sessionAccountIdentity, setCachedRouteSession, getRouteSession } from '../utils/routeSession';
export { SCHOOL_PLANTELES, normalizeSchoolPlantel, deriveSchoolPlantelFromMatricula, schoolGradesForPlantel, normalizeSchoolGrade, normalizeSchoolGradeForPlanteles, compareSchoolPlanteles, compareSchoolGrades, schoolPlantelSqlFromMatricula, SchoolPlantelCode, SchoolGrade } from '../utils/schoolCatalog';
export { DAYCARE_FAMILY_ROLE, DAYCARE_ADMIN_ROLE, SCHOOL_ADMIN_ROLE, MARKETING_ADMIN_ROLE, hasRoleToken, effectiveAdminUser, isEffectiveSuperAdmin, isInstitutionalAdminIdentity, hasFamilyScope, hasDaycareAdminRole, hasSchoolAdminRole, hasMarketingAdminRole, hasDaycareAdminScope, hasSchoolAdminScope, hasMarketingAdminScope, hasAnyAdminScope, requiresInstitutionalOnboarding, defaultAdminRoute, defaultFamilyRoute, defaultSessionRoute, familyNavItems } from '../utils/sessionScopes';
