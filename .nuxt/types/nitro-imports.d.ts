declare global {
  ...
  const assertGestionEscolarAdmin: typeof import('../../server/utils/authz').assertGestionEscolarAdmin
...
export { hasFamilyProductScope, isSuperAdmin, assertDaycareFamily, assertPersonasAutorizadasFamily, assertDaycareAdmin, assertCommunicationsAdmin, assertGestionEscolarAdmin, assertAccessHistoryAdmin, assertUnidadAccess, assertSalaAccess } from 'C:/Users/hp/husky-pass-crm/server/utils/authz';
