declare global {
  ...
  const applyMarbeteTemplateAction: typeof import('../../server/utils/marbeteTemplates').applyMarbeteTemplateAction
  ...
  const assertMarketingAdmin: typeof import('../../server/utils/authz').assertMarketingAdmin
  ...
  const assertSchoolAdmin: typeof import('../../server/utils/authz').assertSchoolAdmin
  const assertSuperAdmin: typeof import('../../server/utils/authz').assertSuperAdmin
  ...
  const authorizedPersonMarbeteSelectionInput: typeof import('../../server/utils/marbeteTemplates').authorizedPersonMarbeteSelectionInput
  ...
  const legacyTransaction: typeof import('../../server/utils/mysql').legacyTransaction
  const legacyWrite: typeof import('../../server/utils/mysql').legacyWrite
  const listBundledMarbeteTemplates: typeof import('../../server/utils/marbeteTemplates').listBundledMarbeteTemplates
  const listCustomMarbeteTemplates: typeof import('../../server/utils/marbeteTemplates').listCustomMarbeteTemplates
  ...
  const normalizeSchoolCycle: typeof import('../../server/utils/marbeteTemplates').normalizeSchoolCycle
  const parseCookies: typeof import('../../node_modules/h3').parseCookies
  const parseOrBadRequest: typeof import('../../server/utils/validation').parseOrBadRequest
  ...
  const resolveEffectiveMarbeteTemplateSvg: typeof import('../../server/utils/marbeteTemplates').resolveEffectiveMarbeteTemplateSvg
  ...
  const saveMarbeteTemplateSettings: typeof import('../../server/utils/marbeteSettings').saveMarbeteTemplateSettings
  const savePersonasConfig: typeof import('../../server/utils/personasConfig').savePersonasConfig
  const saveVisualMarbeteTemplate: typeof import('../../server/utils/marbeteTemplates').saveVisualMarbeteTemplate
  const sealSession: typeof import('../../node_modules/h3').sealSession
  const securityHash: typeof import('../../server/utils/securityDiagnostics').securityHash
  const selectBundledMarbeteTemplate: typeof import('../../server/utils/marbeteTemplates').selectBundledMarbeteTemplate
  const selectCustomMarbeteTemplate: typeof import('../../server/utils/marbeteTemplates').selectCustomMarbeteTemplate
  const selectDevHuskyPassTemplate: typeof import('../../server/utils/devHuskyPassFixtures').selectDevHuskyPassTemplate
  const selectEffectiveMarbeteTemplate: typeof import('../../server/utils/marbeteTemplates').selectEffectiveMarbeteTemplate
  const selectMarbeteTemplate: typeof import('../../server/utils/marbeteTemplates').selectMarbeteTemplate
  const send: typeof import('../../node_modules/h3').send
  const sendDaycareAccessEmail: typeof import('../../server/utils/daycareAccessEmail').sendDaycareAccessEmail
  const sendDaycareRegistrationLinkEmail: typeof import('../../server/utils/daycareRegistrationLinkEmail').sendDaycareRegistrationLinkEmail
...
declare global {
  ...
  // @ts-ignore
  export type { MarbeteRenderValues, MarbeteRequirementStatus, MarbeteTemplateSelectionInput } from '../../server/utils/marbeteTemplates'
...
export { hasFamilyProductScope, isSuperAdmin, assertSuperAdmin, assertDaycareFamily, assertPersonasAutorizadasFamily, assertDaycareAdmin, assertSchoolAdmin, assertMarketingAdmin, assertUnidadAccess, assertSalaAccess } from 'C:/Users/hp/husky-pass-crm/server/utils/authz';
export { sendDaycareAccessEmail } from 'C:/Users/hp/husky-pass-crm/server/utils/daycareAccessEmail';
export { sendDaycareRegistrationLinkEmail } from 'C:/Users/hp/husky-pass-crm/server/utils/daycareRegistrationLinkEmail';
...
export { uploadToExternalService, dataUrlToUploadFile } from 'C:/Users/hp/husky-pass-crm/server/utils/externalUpload';
...
export { parseOrBadRequest } from 'C:/Users/hp/husky-pass-crm/server/utils/validation';