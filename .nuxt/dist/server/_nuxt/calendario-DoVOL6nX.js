  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FamilyResourceList, mergeProps({
        type: "cal",
        title: "Calendario",
        description: "Eventos próximos publicados para la comunidad de guardería."
      }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/familia/daycare/calendario.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=calendario-DoVOL6nX.js.map
