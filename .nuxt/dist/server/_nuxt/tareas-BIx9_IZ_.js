  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FamilyResourceList, mergeProps({
        type: "hw",
        title: "Tareas",
        description: "Tareas publicadas para tu sala de guardería."
      }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/familia/daycare/tareas.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=tareas-BIx9_IZ_.js.map
