...
function experienceThemeVars(identity) {
  const rgb = hexToRgb(identity.primary);
  return {
    "--color-brand-950": identity.context.experience === "admin" ? "#0F172A" : void 0,
...
function resolveVisualIdentity(input = {}) {
...
export {
  resolveExperienceContext as a,
  normalizeInstitutionName as b,
  resolveVisualIdentity as c,
  defaultLoginRouteForExperience as d,
  experienceThemeVars as e,
  normalizeExperienceName as n,
  recoveryRouteForExperience as r,
  visualIdentityForContext as v
};
//# sourceMappingURL=experienceIdentity-DUHnLdZH.js.map
