<template>
  <svg class="pa-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    <path v-if="name === 'people'" d="M8.8 11.6a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4Zm6.8-.8a2.8 2.8 0 1 0 0-5.6 2.8 2.8 0 0 0 0 5.6ZM3.2 18.9c.5-3.1 2.6-5.2 5.6-5.2s5.1 2.1 5.6 5.2c.1.5-.3.9-.8.9H4c-.5 0-.9-.4-.8-.9Zm10.2-4.6c.7-.5 1.4-.7 2.2-.7 2.5 0 4.3 1.8 4.7 4.6.1.5-.3.9-.8.9h-3.6a7.2 7.2 0 0 0-2.5-4.8Z" />
